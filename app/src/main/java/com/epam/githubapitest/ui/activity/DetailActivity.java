...
import com.epam.githubapitest.model.GitHubOwner;
import com.epam.githubapitest.model.GitHubRepository;
import com.epam.githubapitest.network.robospice.CommitRequest;
import com.epam.githubapitest.ui.adapter.CommitAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (params != null) {
            ...
            if (gitHubRepository != null) {
                owner = gitHubRepository.getOwner();
